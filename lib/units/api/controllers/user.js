...
, isUserAllowedToUseAdditionalDevice: isUserAllowedToUseAdditionalDevice
...
function isUserAllowedToUseAdditionalDevice(req, res) {
  return dbapi.isUserAllowedToUseAdditionalDevice(req.user.email)
